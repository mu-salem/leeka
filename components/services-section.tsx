  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-0 left-1/4 w-64 sm:w-96 h-64 sm:h-96 bg-primary/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-0 right-1/4 w-64 sm:w-96 h-64 sm:h-96 bg-primary/10 rounded-full blur-3xl animate-pulse delay-1000" />
      </div>
      {/* card */}
      <div className="relative container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 max-w-full">
